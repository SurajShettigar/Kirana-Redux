...
public:
     ...
     */
    explicit Image(std::string path, bool read_pixels = false);
    ...
    /// @param num_channels If a value greater than 0 is provided, the pixel buffer will have the specified number of channels.
